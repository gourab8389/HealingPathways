  ...
  return (
    <div className='flex flex-col rounded-xl border bg-white shadow-sm dark:border-neutral-800 dark:bg-[#13131a]'>
      <div className="flex justify-between gap-x-3 p-4 md:p-5">
        ...
        <div className="flex size-[46px] w-11 h-11 flex-shrink-0 items-center justify-center rounded-full bg-blue-600 dark:bg-[#1c1c24] text-blue-200">
      ...
      <a href="#" onClick={onClick} className='inline-flex items-center justify-between rounded-xl border-t px-4 py-3 text-sm md:px-5 border-neutral-800 text-neutral-400 hover:bg-neutral-800'>
        {subtitle}
        <IconChevronRight />
      </a>
    </div>
